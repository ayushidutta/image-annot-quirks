classdef rTPKNN_v2
    ...
    methods
        ...
        function [obj] = rTPKNN_v2(dData,dModel,dResults,fTrainFtr,fTestFtr,fTrainAnnot,fTestAnnot ,fModel,fResults)
        ...
        function predict(obj, test_split_idx, test_split_sz, K,w, batch1, batch2)
            ...
            for i=1:batch1:n_rows
                ...
                [scores_ts(:,i:i+batch1-1),~]=Tpknn.predict(dist_ts,Y_tr,K,w);
            end;
            clear dist_ts;
